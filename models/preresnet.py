...
class PreResNet(nn.Module):
    def __init__(self, num_classes=2, depth=20, planes=(16, 32, 64), input_size=32,
        ...
        self.inplanes = 16
        self.conv1 = nn.Conv2d(input_num_channels, 16, kernel_size=3, padding=1, bias=False)
        ...
        self.fc = nn.Linear(coef * planes[2] * block.expansion * int(input_size / 32)**2,
                            num_classes)
